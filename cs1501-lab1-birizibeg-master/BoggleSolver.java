...
public class BoggleSolver
{
	...
	private boolean isValid(int row, int col, int direction){
		if(direction == 0 || direction == 1 || direction == 2) if(row == 0) return false;
		if(direction == 4 || direction == 5 || direction == 6) if(row == 3) return false;
		if(direction == 2 || direction == 3 || direction == 4) if(col == 3) return false;
		if(direction == 0 || direction == 6 || direction == 7) if(col == 0) return false;

		if(Character.isUpperCase(nextChar(row, col, direction))) return false;
